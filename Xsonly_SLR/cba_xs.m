function [nNB,mNB]=cba(nyears,alpha,b,slr,Wn,Wav,Wmin,Wo,p,f,cost,Hav,Dsf,dr,dist2oc0,dist2oc,dist2bb0,dist2bb,kappa,kkappa,npropxs,subsidies)
% this function calculates the net benefit of nourishment and of managed
% retreat based on the work we did for 2017 AGU

% CROSS SHORE ONLY -- this is tricky.. because fixed cost for one house is
% kind of ridiculous. Maybe we can assume no alongshore variation and
% calculate for a community of length L?
