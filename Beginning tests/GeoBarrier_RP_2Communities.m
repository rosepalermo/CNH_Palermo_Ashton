...
xsl(jjcom)=xbb(jjcom)-Wpert;   % X backbarrier
...
for i=1:ts
    ...
    for j = 1:ys
        ...
        %changed for nourishment
        xsl(j)=xsl(j)+xsdot*dt-2*Vnn/(2*H+Dt);
