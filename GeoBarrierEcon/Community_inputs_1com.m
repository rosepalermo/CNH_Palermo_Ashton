...
ncom = 1;                      % number of communities
com(1).jj = Yi(floor(length(Yi)/3):floor(2/3*length(Yi)));             % 1 represents community 1
...
com(1).Kow = 0.1;              % residential, 40% overwash lost (Rogers et al 2015)
