...
if save_on
    if xsonly
        ...
        filename = sprintf('XS_%s_OW%d_K%d_SLa%d_RCP%d_diff%d',shape,Qow_max,Ksf,sl_a*1000,RCP,astfac*10);
    elseif developed_on
        if commercial
            foldername = "/Users/rosepalermo/Documents/Research/Alongshore coupled/GeoBarrierModelOutput/developedc/";
            filename = sprintf('DC_%s_OW%d_K%d_SLa%d_RCP%d_diff%d',shape,Qow_max,Ksf,sl_a*1000,RCP,astfac*10);
        elseif residential
            foldername = "/Users/rosepalermo/Documents/Research/Alongshore coupled/GeoBarrierModelOutput/developedr/";
            filename = sprintf('DR_%s_OW%d_K%d_SLa%d_RCP%d_diff%d',shape,Qow_max,Ksf,sl_a*1000,RCP,astfac*10);
        end
    elseif community_on
        foldername = "/Users/rosepalermo/Documents/Research/Alongshore coupled/GeoBarrierModelOutput/populated/";
        filename = sprintf('COM_%s_OW%d_K%d_SLa%d_RCP%d_diff%d',shape,Qow_max,Ksf,sl_a*1000,RCP,astfac*10);
    else
        foldername = "/Users/rosepalermo/Documents/Research/Alongshore coupled/GeoBarrierModelOutput/natural/";
        filename = sprintf('NAT_%s_OW%d_K%d_SLa%d_RCP%d_diff%d',shape,Qow_max,Ksf,sl_a*1000,RCP,astfac*10);
    end
