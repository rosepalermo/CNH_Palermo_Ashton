...
for runn=1:runn
    ...
    for i=1:ts
        ...
        Beta1_1(i,runn) = nproperties*L1/dy * alpha1 * ((((Wn1+W1av)./W1(1,1))^b) - (mean(W1(i,:))-slr)./W1(1,1)^b);
        ...
        if min(W1(i,:))<=1
            Beta1mr_1(i,runn) = nproperties*L1/dy * alpha1 * ((((propertysize+W1av)./W1(1,1))^b) - (mean(W1(i,:))-slr)./W1(1,1)^b);
        ...
        Beta2_1(i,runn) = nproperties*L2/dy * alpha1 * ((((Wn2+W2av)./W2(1,1))^b) - (mean(W2(i,:))-slr)./W2(1,1)^b);
        ...
        if min(W2(i,:))<=1
            Beta2mr_1(i,runn) = nproperties*L2/dy * alpha1 * ((((propertysize+W2av)./W2(1,1))^b) - (mean(W2(i,:))-slr)./W2(1,1)^b);
