%  plot mean slx as a function of changing Wstart
...
filter_func = @(params) filter_L(params, 50, 50) && ... % range is 10-90
    ...
    filter_Qow_max(params, 10, 10) && ... % range is 5-50
...
for i=1:length(files)
    ...
    if filter_func(params)
        ...
        slx(ii,:) = result.mean_slx-result.mean_slx(1,1);
...
title('Wstart, given ast = 0.3, Qow = 10, ')
legend('150','200','250','300','350','400')
xlabel('time yrs')
ylabel('shoreline change (meters)')
