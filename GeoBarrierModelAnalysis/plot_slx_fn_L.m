% plot mean slx as a function of L. For the cases tested, there was little
% change between runs. ~30 m after 200 years. For Wstart 300, they are the
% exact same

%  SLX IS THE SAME FOR ALL L IN THESE CASES. VERY BORING
...
filter_func = @(params) filter_L(params, 10, 90) && ... % range is 10-90
    ...
    filter_Wstart(params, 350, 350); % range is 150-400
