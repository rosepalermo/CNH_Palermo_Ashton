...
xsl(jjpert)=xbb(jjpert)-Wpert;   % X backbarrier
notpert = setdiff(Yi,jjpert); %part of the shoreline not on community
...
%     
%     %nourish if the width is less than 175
%     for jj = jjpert(1):jjpert(end)
%         if Width(jj) < 175
%             xsl(jj) = xsl(jj) -20;
%             numnourished(jj) = 1;
